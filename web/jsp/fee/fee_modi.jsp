...
<div id="main">
    ...
    <form:form action="updateCost.do" method="post" cssClass="main_form" commandName="cost">
        ...
        <div class="input_info fee_type">
            <form:radiobutton path="cost_type" id="monthly" value="1" onclick="feeTypeChange(1);"/>
            <label for="monthly">包月</label>
            <form:radiobutton path="cost_type" id="package" value="2" onclick="feeTypeChange(2);"/>
            <label for="package">套餐</label>
            <form:radiobutton path="cost_type" id="timeBased" value="3" onclick="feeTypeChange(3);"/>
